...
<head>
    ...
    <title> Curso de Robótica Módulo 1 | AROTEC</title>
...
<div class="row">
    <div class="col-12 col-lg-9 col-md-9 col-xs-9 px-lg-4 px-md-3 col-sm-12">
        <br>
        <img src="imagens/r1.png" height="50em" alt="">
        <br>  <br>
        <h3 class="text-primary">Curso de Robótica Módulo 1</h3>
        ...
        <br>
        <div class="banner">
            <img src="imagens/rbm1.jpeg"style="height: 25rem!important; width:100%" alt="">
        </div>
        <center>
            <br>
...
<br><br><br>
    ...
    <div class="col-12 col-lg-3 col-md-3 col-xs-3 col-sm-12 text-center">
        ...
        <br><br>
        <center>
            <a href="insc_curso.php?c=robotica_m1"><button class="btn btnn " style="position: absolute; bottom: 1rem; left:1rem; right: 1rem;">Increver-se</button></a>
        </center>
