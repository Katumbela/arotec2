...
<head>
    ...
    <title> Curso de Eletrônica | AROTEC</title>
...
<div class="row">
    <div class="col-12 col-lg-9 col-md-9 col-xs-9 px-lg-4 px-md-3 col-sm-12">
        <h3 class="text-primary">Curso de Eletrônica</h3>
        ...
        <br>
        <div class="banner">
            <img src="imagens/eletronica.jpeg"style="height: 25rem!important; width:100%" alt="">
        </div>
        <center>
            <br>
        <div class="detalhes px-5">
            <div class="row text-center">
                <div class="col-6 col-lg-3 col-md-3 col-sm-3 col-xs-3 text-start">
                    <div class="column">
                ...
                <div style="border-left: 1px solid #808080b2;border-right: 1px solid #808080b2;" class="col-6 col-lg-3 col-md-3 col-sm-3 col-xs-3 text-start">
                    <div class="column">
                        <span class="text-secondary f-15">
                ...
                <div  class="col-6 col-lg-3 col-md-3 col-sm-3 col-xs-3 text-start">
                    <div class="column">
                        ...
                        <b class="mx-3">1 hora</b>
                    </div>
                </div>
                <div style="border-left: 1px solid #808080b2;"  class="col-6 col-lg-3 col-md-3 col-sm-3 col-xs-3 text-start">
                    <div class="column">
                        <span class="text-secondary f-15">
        ...
        <p>
        O curso de eletrônica e curso pratico que oferece a estudante a habilidade de construir sistemas eletrônicas, usar Bread-boards e se familiarizar com mais diversos sensores.  
        </p>
        <br><br>
        </div>
        ...
        <div id="topic">
            <div class="bg-light p-4">
                ...
                <ul class="t-list w-75">
                    <li>	Introdução a eletrônica e eletricidade </li>
                    <li>    Eletrônica Analógica</li>
                    <li>    Eletrônica Digital</li>
                    <li>	Criação de projectos de electronica </li>
                </ul>
            </div>
        </div>
        ...
        <div id="oque" class=" p-5">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Como montar circuitos elétricos  <br> <br> •	Trabalhar em equipa </p>
                </div>
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75"> •	  Desenvolvimento de projecos</p>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Uso de ferramentas e instrumentos na area eletrônicas.  </p>
                </div>
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75"> •	Pensamento criativo </p>
                </div>
            </div>
        </div>
...
<br><br><br>
            ...
            <div>
                ...
                <div class="ps column">
                    ...
                    <div class="corpo w-50">
                        <h4><b class="text-primary">Eng. Cristovao Cacombe </b></h4>
    ...
    <div class="col-12 col-lg-3 col-md-3 col-xs-3 col-sm-12 text-center">
        ...
        <br><br>
        <center>
            <a href="insc_curso.php?c=eletronica"><button class="btn btnn w-75" style="position: relative; bottom: 1rem;">Increver-se</button></a>
        </center>
