...
<head>
    ...
    <title> Curso de Mecânica e Eletrônica Industrial | AROTEC</title>
...
<div class="row">
    <div class="col-12 col-lg-9 col-md-9 col-xs-9 px-lg-4 px-md-3 col-sm-12">
        <h3 class="text-primary">Curso de Mecânica e Eletrônica Industrial</h3>
        ...
        <div class="content w-50">
            <p>
             Estudantes e interessados em mecânica industrial tanto quanto eletrõnica, estudando em um só
        </p>
        </div>
        <br>
        <div class="banner">
            <img src="imagens/mecanica.jpeg"style="height: 25rem!important; width:100%" alt="">
        </div>
        <center>
            <br>
        ...
        <p>
        O curso de mecânica e eletrônica industrial visa levar ao alunos os princípios mecânicos e eletrônicos para trabalhar em uma fábrica ou indústria.  
        </p>
        <br><br>
        </div>
        ...
        <div id="topic">
            <div class="bg-light p-4">
                ...
                <ul class="t-list w-75">
                    <li> Introdução a mecânica e eletrônica industrial  </li>
                    <li> Maquinas elétricas </li>
                    <li>	Robotica e automação  </li>
                    <li>	Desenho assistido por computadores  </li>
                    <li>	Desenho assistido por computadores  </li>
                </ul>
            </div>
        </div>
        ...
        <div id="oque" class=" p-5">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Como montar e controlar um sistema industrial  </p>
                </div>
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Trabalhar em equipa <br><br> •	Pensamento criativo</p>
                </div>
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Desenvolvimento de projecto <br><br> </p>
                </div>
            </div>
        </div>
...
<br><br><br>
            ...
            <div>
                ...
                <div class="ps column">
                    ...
                    <div class="corpo w-50">
                        <h4><b class="text-primary">Rabi</b></h4>
    ...
    <div class="col-12 col-lg-3 col-md-3 col-xs-3 col-sm-12 text-center">
        ...
        <br><br>
        <center>
            <a href="insc_curso.php?c=industrial"><button class="btn btnn w-75" style="position: relative; bottom: 1rem; ">Increver-se</button></a>
        </center>
