...
<head>
    ...
    <title> Curso de Arduino | AROTEC</title>
...
<div class="row">
    <div class="col-12 col-lg-9 col-md-9 col-xs-9 px-lg-4 px-md-3 col-sm-12">
        <img src="imagens/cc.png" height="50em" alt="">
        <br> 
        <h3 class="text-primary">Curso de Arduino</h3>
        ...
        <div class="content w-50">
            <p>
                Formação e capacitação em arduino para desenvlvimento de projectos, protóipos e outros     
        </p>
        </div>
        <br>
        <div class="banner">
            <img src="imagens/arduino.jpeg"style="height: 25rem!important; width:100%" alt="">
        </div>
        <center>
            <br>
        ...
        <p>O curso de Arduino da todas necessárias para a estudantes poder desenvolver projetos usando o microntrolador Arduino e das habilidades de uso de diversos sensores. </p>
        <br><br>
        </div>
        ...
        <div id="topic">
            <div class="bg-light p-4">
                ...
                <ul class="t-list w-75">
                    <li>	Introdução ao Arduino </li>
                    <li>	Programação em Arduino </li>
                    <li>	Sensores </li>
                    <li>Criação de projecto</li>
                </ul>
            </div>
        </div>
        ...
        <div id="oque" class=" p-5">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Uso de ferramentas e de eletrônica </p>
                </div>
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Arduino </p>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Programação <br><br> •	Trabalhar em equipa</p>
                </div>
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Pensamento criativo <br><br> •	Desenvolvimento de projecto</p>
                </div>
            </div>
        </div>
...
<br><br><br>
            ...
            <div>
                ...
                <div class="ps column">
                    ...
                    <div class="corpo w-50">
                        <h4><b class="text-primary">Sião Cabeia</b></h4>
    ...
    <div class="col-12 col-lg-3 col-md-3 col-xs-3 col-sm-12 text-center">
        ...
        <br><br>
        <center>
            <a href="insc_curso.php?c=arduino"><button class="btn btnn w-75" style="position: relative; bottom: 1rem; ;">Increver-se</button></a>
        </center>
