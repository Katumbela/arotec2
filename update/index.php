...
.cursos .imagenm4{
    ...
    background:  url(py1.jpeg) center center;
}
...
<div class="container">
    ...
    <div class="col-12 col-lg-6 col-md-6 col-xs-6 py-lg-5">
        ...
        Consultoria e design de dispositivos e softwares inteligentes. Soluções e programas sociais para empresas.
             <br>
             <br>
            <a href="empresas" class="btn login">Saber mais <svg class="svg" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
        <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"/>
        </svg></a>
        </p>
    </div>
        ...
        <div class="">
                <div class="column">
                    ...
                    <div class="conteudo">
                        ...
                        <br>
                        <center>
                                 <a href="livro_inteligente"><button class="btn ic btn-outline-primary"> Comprar <i class="bi bi-bag-heart"></i></button></a>
                        </center>
                    </div>
                </div>
            </div>
