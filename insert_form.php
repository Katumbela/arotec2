...
$tel = $_POST['tel'];
$provincia = "default - o mesmo do cadastro";
...
$inserir = "INSERT INTO `inscricao` (`nome`, `sobrenome`, `email`, `provincia`, `telefone`, `curso`, `senha`, `data_da_incricao`) VALUES ( '$user', '$user', '$email', '$provincia', '$tel', '$curso', '$senha', now())";
