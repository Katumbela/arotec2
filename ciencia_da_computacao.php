...
<head>
    ...
    <title> Curso de Introdução à ciência da computação com python | AROTEC</title>
...
<div class="row">
    <div class="col-12 col-lg-9 col-md-9 col-xs-9 px-lg-4 px-md-3 col-sm-12">
        <br>
        <img src="imagens/python.png" height="40em" alt="">
        <br>  <br>
        <h3 class="text-primary">Introdução à ciência da computação com Python</h3>
        ...
        <div class="content w-50">
            <p>
                Descricao do curso sobre as suas aplicações, vantagens e aplicabilidadees resolvesndo certas coisas ou mais 
            </p>
        </div>
        <br>
        <div class="banner">
            <img src="imagens/science.jpeg"style="height: 25rem!important; width:100%" alt="">
        </div>
        <center>
            <br>
        ...
        <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Esse porro, libero sed quas reprehenderit adipisci impedit ipsum illo natus ea voluptates numquam repellendus, quibusdam repudiandae deserunt odio. Cum, eius debitis. <br><br>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi laboriosam illum velit! Facere reprehenderit dolorem, ad similique itaque alias iste velit error id accusamus rem a eaque quia aliquid cum?
        </p>
        <br><br>
        </div>
        ...
        <div id="topic">
            <div class="bg-light p-4">
                ...
                <ul class="t-list w-75">
                    <li>Topico de alguma coisa Topico de alguma coisa Topico de alguma coisa Topico de alguma coisa Topico de alguma coisa </li>
                    <li>Topico de alguma coisa  Topico de alguma coisa Topico de alguma coisa Topico de alguma coisa Topico de alguma coisa Topico de alguma coisa </li>
                    <li>Topico de alguma coisa  Topico de alguma coisa Topico de alguma coisa Topico de alguma coisa Topico de alguma coisa Topico de alguma coisa </li>
                </ul>
            </div>
        </div>
        ...
        <div id="oque" class=" p-5">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
                </div>
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
                </div>
...
<br><br><br>
    ...
    <div class="col-12 col-lg-3 col-md-3 col-xs-3 col-sm-12 text-center">
        ...
        <br><br>
        <center>
            <a href="insc_curso.php?c=computacao"><button class="btn btnn " style="position: absolute; bottom: 1rem; left:1rem; right: 1rem;">Increver-se</button></a>
        </center>
