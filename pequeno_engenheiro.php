...
<head>
    ...
    <title> Curso de Pequeno Engenheiro | AROTEC</title>
...
<div class="row">
    <div class="col-12 col-lg-9 col-md-9 col-xs-9 px-lg-4 px-md-3 col-sm-12">
        <br>
        <img src="imagens/arobot.png" height="50em" alt="">
        <br>  <br>
        <h3 class="text-primary">Curso de Pequeno Engenheiro</h3>
        ...
        <div class="content w-50">
            <p>
               Curso feito e direccionado para menores que queiram se aventurar neste mundo que é a Tecnologia e robótica
            </p>
        </div>
        <br>
        <div class="banner">
        <center>
            <img src="imagens/aroo.jpeg"style="height: 25rem!important; width: 60% " alt="">
        </div>
            <br>
        ...
        <p>
        O curso pequeno engenheiro permite a crianças dos 7 aos 14 anos ter uma boa introdução ao mundo de ctem (ciência, tecnologias, engenharia e matemáticas). <br> A criança vai ter experencia pratica com várias tecnologias como robótica, impressão 3d, drones e outros. 
        </p>
        <br><br>
        </div>
        ...
        <div id="topic">
            <div class="bg-light p-4">
                ...
                <ul class="t-list w-75">
                    <li>1.	Introdução a robótica </li>
                    <li>2.  Impressão 3D</li>
                    <li>3.	Princípios de voos </li>
                </ul>
            </div>
        </div>
        ...
        <div id="oque" class=" p-5">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Como montar e controlar um robô </p>
                </div>
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Uso de ferramenta </p>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">•	Trabalhar em equipa </p>
                </div>
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
...
<br><br><br>
            ...
            <div>
                ...
                <div class="ps column">
                    ...
                    <div class="corpo w-50">
                        <h4><b class="text-primary">Jonilson Correia</b></h4>
    ...
    <div class="col-12 col-lg-3 col-md-3 col-xs-3 col-sm-12 text-center">
        ...
        <div class="i-corp"><br>
            <b class="preco"><span class="aoa">AOA</span>12.000</b>
        </div><br>
        ...
        <br><br>
        <center>
            <a href="insc_curso.php?c=eng"><button class="btn btnn w-75" style="position: relative; bottom: 1rem;">Inscrever-se</button></a>
        </center>
