...
@media only screen and (min-width:1050px) and (max-width:1300px) {
    ...
    @media screen and (max-width: 700px){
        ...
        .img-c1, .img-c2, .img-c3{
            width: 90%!important;
        }
    }

    .img-c1{
        background: url(imagens/cat.jpg) center center;
        background-size: cover;
        height: 25vh;
        width: 20vw;
        margin-bottom: 1rem;
    ...
    .img-c2{
        background: url("imagens/unitelc.jpeg") center center;
        background-size: cover;
        height: 25vh;
        width: 20vw;
        margin-bottom: 1rem;
...
<h2 class="text-white">Para Empresas</h2>
...
<br>
  ...
  <div class="container xyz-in example-grid text-start">
        <div xyz="fade small stagger" class="px-lg-5">
       
            <div class="row descc">
                <div class="col-12 col-lg-8 col-md-6 col-sm-12 col-xs-8 xyz-in">
                    <h1 class="titt">Desde dispositivos inteligentes, softwares e IA</h1>
                    <p>A Arotec composto por engenheiros especialistas em hardware e softwares inteligentes oferece soluções para design, desenvolvimentos e fabricação de hardware e softwares.</p>
            
                </div>
                <div class="col-12 col-lg-4 text-center col-md-6 col-sm-12 col-xs-4  xyz-in">
                    <img src="imagens/market.jpeg" height="200em" style="border-radius:20px" alt="">
                </div>
        </div>
        <br>
        <br>
        <hr>
        <br>
        <h2 ><b>Soluções desenvolvidas </b></h2><br>
        <div class="row  example-grid" xyz="fade small stagger">
            <div class="col-12 col-lg-4 px-5   my-4 my-4 col-md-3 col-sm-12 col-xs-4 xyz-in ">
                <div class="cardd">
                    <div class="column">
                        <div class="img-c2"></div>
                        <div class="corp">
                            <h3>Responsabilidade social empresas: </h3>
                            <p>
                            A arotec oferece formações especializadas para as áreas de responsabilidades das empresas. Formações nas áreas de ctem (ciência, tecnologia, engenharia e matemática).</p>
                        
                            <br>
                            <ul class="servs">
                                <li><a href=""><img src="imagens/unitel.png" height="30em" alt=""></a></li>
            ...
            <div class="col-12 col-lg-4 my-4 col-md-3 col-sm-12 px-5 col-xs-4 xyz-in">
                <div class="cardd">
                    <div class="column">
                        <div class="img-c1"></div>
                        <div class="corp">
                            <h3>Aulas de robótica para escolas </h3>
                            <p>
                            Oferecemos tutores e programas para ensino de robótica nas escolas, programas extras curriculares e inserção da robótica no currículo escolar.</p>
                        
                            <br>
                            <ul class="servs">
                                <li><a href=""><img src="imagens/cat-logo.jpeg" style="border-radius: 50px" height="60em" alt=""></a></li>
            ...
            <div class="col-12 col-lg-4 my-4 col-md-3 px-5  col-sm-12 col-xs-4 xyz-in">
                <div class="cardd">
                    <div class="column">
                        <div class="img-c3"></div>
                        <div class="corp">
                            <h3>Consultoria e criação de laboratórios </h3>
                            <p>
...
<div class="serv text-start">
    <br>
<hr><br>
<b class="text-primary">Parceiros</b>
<br>
<br>
<ul class="servs">
    <li><a href=""><img src="imagens/transferir.jpeg" height="60em" alt=""></a></li>
    <li><a href=""><img src="imagens/hub.jpeg" height="60em" alt=""></a></li>
    <li><a href=""><img src="imagens/ggpn.jpeg" height="60em" alt=""></a></li>
</ul>
</div>
...
<footer class="bg-light pt-5  pb-2 page-footer">
    <div class="container">
      <div class="row container">
        ...
        <div class="col-12 col-lg-4 col-sm-4 col-md-4">
            ...
            <ul>
              <li><a class="text-secondary" href="index#sobre">Quem Somos?</a></li>
              <li><a class="text-secondary" href="index#sobre">Quando Surgiu?</a></li>
            </ul>
        ...
        <div class="col-12 col-lg-4 col-sm-4 col-md-4">
          ...
          <ul>
            ...
            <li><a class="text-secondary" href="tel:+244938811659"> +244 938811659</a></li>
            <li><a class="text-secondary" href="tel:+244990811659"> +244 990811659</a></li>
            <li><a class="text-secondary" href="mailto:info.arotec@gmail.com">arotec.info@gmail.com</a></li>
    ...
    <div class="footer-copyright center mt-4">
      <div class="container">
      <a class="span text-secondary text-s"  href="/"> &copy; AROTEC &middot; Todos os direitos reservados</a><br>
