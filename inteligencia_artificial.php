...
<head>
    ...
    <title> Curso de Introdução à Inteligencia Artificial | AROTEC</title>
...
<div class="row">
    <div class="col-12 col-lg-9 col-md-9 col-xs-9 px-lg-4 px-md-3 col-sm-12">
        <h3 class="text-primary">Introdução à Inteligencia Artificial com Python</h3>
        ...
        <div class="content w-50">
            <p>
            O curso de inteligência artificial da uma introdução nas áreas de inteligência artificial com foco em sua aplicação e diversas técnicas como logica fuzzy, regressão.          </p>
        </div>
        <br>
        <div class="banner">
            <img src="imagens/ia2.webp"style="height: 25rem!important; width:100%" alt="">
        </div>
        <center>
            <br>
        <div class="detalhes px-5">
            <div class="row text-center">
                ...
                <div style="border-left: 1px solid #808080b2;border-right: 1px solid #808080b2;" class="col-3 col-lg-3 col-md-3 col-sm-3 col-xs-3 text-start">
                    <div class="column">
                        <span class="text-secondary f-15">
                            <i class="bi bi-globe mx-2"></i></i> 100% Online
                        </span><br>
        ...
        <p>
            Este curso é ministrado pela AROTEC, um curso que visa capacitar lhe a começar com desenvolvimento de IA´s caso ainda não tenha conhecimento algum do assunto. <br><br>
            e este curso é direcionado também para aqueles que possam ter conhecimento algum na matéria e queiram aprofundar mais o seu conhecimento e dar suporte nos  seus projectos?
        </p>
        <br><br>
        </div>
        ...
        <div id="topic">
            <div class="bg-light p-4">
                ...
                <ul class="t-list w-75">
                    <li>Básico, conceitos da linguagem </li>
                    <li>Datatypes, Variáveis e  operadores </li>
                    <li>Manipulação de String lista e dicionário em Python </li>
                    <li>Familiarize-se com as funções e módulos Python </li>
                    <li>Operações de arquivo Python </li>
                    <li>Abordagem Orientada a Objetos em Python</li>
                    <li>	Introdução a IA</li>
 <li>	Terminologia e aplicação</li>
	 <li>Fuzzy logica</li>
	<li>Ética em AI </li>
	<li>Futuro da AI </li>
	 <li>Neuro networks</li>

                    <li>Expressões Regulares e Tratamento de Exceções em Python</li>
                </ul>
            </div>
        </div>
        ...
        <div id="oque" class=" p-5">
            <center><h2><b> Habilidades a adquirir </b></h2>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">Desenvolver uma IA aplicada à máquinas.</p>
                </div>
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">Estruturar uma IA fundamental.</p>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">Desenvolver redes neurais.</p>
                </div>
                <div class="col-12 col-lg-6 col-md-6 col-xs-6 col-sm-12" style="display: flex!important; flex-direction: row!important">
                    <span><i class="bi bi-check2-square mx-3"></i></span><p class="w-75">Aplicar ou desenvolver IA para robôs .</p>
                </div>
            </div>
        </div>
...
<br><br><br>
            ...
            <div>
                ...
                <div class="ps column">
                    ...
                    <div class="corpo w-50">
                        <h4><b class="text-primary">Nome do formador</b></h4>
                        <span class="text-secondary f-15 text-start">Função ou algo parecido ou ainda descricao deste formador.  ou ainda descricao deste formador</span>
                    </div>
                </div>
            </center>
            </div>
        ...
        <div class="text-start">
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u=https://aro-tec.net/academia">
	<button class="btn btnn" id="copy">
                <span><i class="bi bi-share"></i></span> Partilhar curso
                <i class="bi bi-facebook ml-4"></i></button>
</a>
        </div>
    ...
    <div class="col-12 col-lg-3 col-md-3 col-xs-3 col-sm-12 text-center">
        ...
        <br><br>
        <center>
            <a href="insc_curso.php?c=int_artificial"><button class="btn btnn w-75" style="position: relative; bottom: 1rem; ">Increver-se</button></a>
        </center>
...
<footer class="bg-light pt-5  pb-2 page-footer">
  ...
  <path d="M8.051 1.999h.089c.822.003 4.987.033 6.11.335a2.01 2.01 0 0 1 1.415 1.42c.101.38.172.883.22 1.402l.01.104.022.26.008.104c.065.914.073 1.77.074 1.957v.075c-.001.194-.01 1.108-.082 2.06l-.008.105-.009.104c-.05.572-.124 1.14-.235 1.558a2.007 2.007 0 0 1-1.415 1.42c-1.16.312-5.569.334-6.18.335h-.142c-.309 0-1.587-.006-2.927-.052l-.17-.006-.087-.004-.171-.007-.171-.007c-1.11-.049-2.167-.128-2.654-.26a2.007 2.007 0 0 1-1.415-1.419c-.111-.417-.185-.986-.235-1.558L.09 9.82l-.008-.104A31.4 31.4 0 0 1 0 7.68v-.123c.002-.215.01-.958.064-1.778l.007-.103.003-.052.008-.104.022-.26.01-.104c.048-.519.119-1.023.22-1.402a2.007 2.007 0 0 1 1.415-1.42c.487-.13 1.544-.21 2.654-.26l.17-.007.172-.006.086-.003.171-.007A99.788 99.788 0 0 1 7.858 2h.193zM6.4 5.209v4.818l4.157-2.408L6.4 5.209z"/>
      ...
      <input type="text" style="display:none" value="www.aro-tec.net/inteligencia_artificial" class="text">
