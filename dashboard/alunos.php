...
<div class="col l3 m3 s12 container center">
       <a href="alunos.php" class="activo"> <?=$a?> Alunos</a>
  </div>
  <div class="col l3 m3 s12 container center">
...
<br>
<br><br>
<h4 class="cor">Alunos cadastrados ( <?=$q?>)</h4>
<hr>
<table>
  <thead>
    <tr>
  ...
  <tbody>
      ...
      <tr>
            <td><?=$dad['id']?></td>
            <td><?=$dad['nome']." ".$dad['sobrenome']?></td>
            <td><?=$dad['email']?></td>
            <td><?=$dad['telefone']?></td>
            <td><?=$dad['provincia']?></td>
            <td><?=$dad['curso']?></td>
            <td><?=$dad['data_da_incricao']?></td>
      </tr>
         <?php
