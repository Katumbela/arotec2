...
$see2= "SELECT * FROM aulas";
$conn2 = $conexao->query($see2);
$au = mysqli_num_rows($conn2);
...
<div class="col l3 m3 s12 container center">
  ...
  <div class="col l3 m3 s12 container center">
    <a href="loja.php"> <?=$l?> Loja</a>
  </div>
  <div class="col l3 m3 s12 container center">
    <a href="cursos.php" class="activo"><?=$au?> Aulas</a>
  </div>
</div>
...
<br>
<br><br>
<div> <h4 class="cor">Número de estudantes por curso</h4></div>
<hr>

<div class="row">
    <div class="col l3 m4 s12">
        <a href="p_eng.php">Pequeno Engenheiro  <?php
                    
            $see= "SELECT * FROM inscricao WHERE curso='Pequeno Engenheiro'";
            $conn = $conexao->query($see);
            $c1 = mysqli_num_rows($conn);
            echo"( ".$c1." )";

        ?></a>
    </div>
    <div class="col l3 m4 s12">
        <a href="p_eng.php">Eletrónica e Mecanica <?php
                    
                    $see= "SELECT * FROM inscricao WHERE curso='Mecanica Industrial'";
                    $conn = $conexao->query($see);
                    $c1 = mysqli_num_rows($conn);
                    echo"( ".$c1." )";
    ...
    <div class="col l3 m4 s12">
        <a href="p_eng.php">Robótica Módulo 1 <?php
                    
                    $see= "SELECT * FROM inscricao WHERE curso='Robotica Módulo 1'";
                    $conn = $conexao->query($see);
                    $c1 = mysqli_num_rows($conn);
                    echo"( ".$c1." )";
    ...
    <div class="col l3 m4 s12">
        <a href="p_eng.php">Robótica Módulo 2 <?php
                    
                    $see= "SELECT * FROM inscricao WHERE curso='Robotica Módulo 2'";
                    $conn = $conexao->query($see);
                    $c1 = mysqli_num_rows($conn);
                    echo"( ".$c1." )";
...
<br>
<center>
   <a href="add_lessons.php" class="white-text"> <button class="btn outline primary" style="border-radius: 20px"> Adicionar Aulas</button></a>
</center>
